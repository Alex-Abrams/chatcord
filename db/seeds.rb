...
comment1 = Comment.create(msg_board_id: message_board1.id, user_id: user1.id, username: user1.username, body: 'POGCHAMPS')
comment1 = Comment.create(msg_board_id: message_board1.id, user_id: user1.id, username: user1.username, body: 'chardie')
comment1 = Comment.create(msg_board_id: message_board1.id, user_id: user2.id, username: user2.username, body: 'where the boys at??')
comment1 = Comment.create(msg_board_id: message_board2.id, user_id: user2.id, username: user2.username, body: 'gg ex game 5v1')
comment1 = Comment.create(msg_board_id: message_board2.id, user_id: user2.id, username: user2.username, body: 'i aint hearing no fish')
comment1 = Comment.create(msg_board_id: message_board2.id, user_id: user2.id, username: user2.username, body: 'pitter patter')
comment1 = Comment.create(msg_board_id: message_board3.id, user_id: user2.id, username: user2.username, body: 'say a man eat his own head')
comment1 = Comment.create(msg_board_id: message_board3.id, user_id: user3.id, username: user3.username, body: 'i dream of a pruple tiger')
comment1 = Comment.create(msg_board_id: message_board4.id, user_id: user3.id, username: user3.username, body: 'where the money at?')
comment1 = Comment.create(msg_board_id: message_board4.id, user_id: user3.id, username: user3.username, body: 'hire me pls')
comment1 = Comment.create(msg_board_id: message_board5.id, user_id: user3.id, username: user3.username, body: 'godzilla was prewtty cool')
comment1 = Comment.create(msg_board_id: message_board6.id, user_id: user3.id, username: user3.username, body: 'the expanse is the best show')
comment1 = Comment.create(msg_board_id: message_board6.id, user_id: user4.id, username: user4.username, body: 'game of thrones season 7 and 8 sucked donkey balls')
comment1 = Comment.create(msg_board_id: message_board6.id, user_id: user4.id, username: user4.username, body: 'fire the thrusters to get me the hell out of here')
comment1 = Comment.create(msg_board_id: message_board6.id, user_id: user4.id, username: user4.username, body: 'wankers')
comment1 = Comment.create(msg_board_id: message_board6.id, user_id: user4.id, username: user4.username, body: 'POGCHAMPS')
